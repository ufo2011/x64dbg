...
Floating-point registers like XMM0, YMM0, ZMM0, K0 or ST(0) may not be used as variables and do not support scalar assignment syntax. They may be logged via the [String Formatting](./Formatting.md) floating-point type. Use commands [movdqu](../commands/general-purpose/movdqu.md), [vmovdqu](../commands/general-purpose/vmovdqu.md), and [kmovd](../commands/general-purpose/kmovd.md) to access floating-point registers.
